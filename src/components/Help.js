  ...
  constructor(props, context) {
    ...
    render() {
      ...
      <div className="Main-background Help-text-left">
        ...
        <h3 className="Help-title"><img src={clockPink} className="Help-img"/>When To Post</h3>
        ...
        <h3 className="Help-title"><img src={followerPink} className="Help-img"/>Follower Growth</h3>
        <p className="Help-text">
        ...
        <h3 className="Help-title"><img src={heartPink} className="Help-img"/>Top Posts</h3>
        <p className="Help-text">
